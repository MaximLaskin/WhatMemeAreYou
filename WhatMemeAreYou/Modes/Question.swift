...
extension Question {
    ...
    static func getQuestions() -> [Question] {
          [
            Question(
                title: "Каким файлообменником ты пользуешься?",
                type: .single,
                answers: [
                    Answer(title: "ICQ", type: .dog),
                    Answer(title: "Голубиная почта", type: .cat),
                    Answer(title: "Скааайп", type: .rabbit),
                    Answer(title: "Это что такое?", type: .turtle)
                ]
            ),
            Question(
